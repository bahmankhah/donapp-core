            ...
            <div class="inbox-export-buttons">
                <div class="export-dropdown">
                    ...
                    <div class="export-dropdown-content" id="exportDropdown">
                        <a href="<?= esc_url($inbox_csv_url) ?>" class="export-option csv" target="_blank"
                        ...
                        <a href="<?= esc_url($inbox_pdf_url) ?>" class="export-option pdf" target="_blank"
    ...
    <?php if (!empty($entries)): ?>
        ...
        <form id="bulk-action-form" class="donap-bulk-actions-form" style="margin-bottom: 15px;">
            <div style="">
                ...
                <button type="button" id="bulk-action-apply" class="donap-action-btn"
                    style="background: #667eea; padding: 8px 16px; font-size: 14px;" disabled>
                    ...
                    <tr>
                        <td data-label="انتخاب">
                            <input type="checkbox" class="entry-checkbox" name="entry_ids[]"
                                value="<?php echo intval($entry['id']); ?>">
                        </td>
                        <td data-label="فرم">
                                ...
                                <?php foreach ($entry['actions'] as $action): ?>
                                    <?php if ($action['type'] === 'view' && !empty($action['url'])): ?>
                                        ...
                                        <a href="<?php echo esc_url($new_url); ?>"
                                            class="donap-action-btn <?php echo esc_attr($action['type']); ?>" target="_blank">
                                            <i class="fas fa-eye"></i>
                                            <?php echo esc_html($action['label']); ?>
                                        </a>
                                    <?php else: ?>
                                        <button type="button" class="donap-action-btn <?php echo esc_attr($action['type']); ?>"
    ...
    <?php if ($show_pagination && $pagination['total_pages'] > 1): ?>
        <div class="donap-pagination">
            <div class="donap-pagination-info">
                نمایش <?php echo intval($pagination['current_page']); ?> از
                <?php echo intval($pagination['total_pages']); ?>
