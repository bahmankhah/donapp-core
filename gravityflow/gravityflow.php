...
define( 'GRAVITY_FLOW_VERSION', '2.9.6' );
...
if ( ! defined( 'GRAVITY_FLOW_LICENSE_KEY' )) {
    define ('GRAVITY_FLOW_LICENSE_KEY', '123456-123456-123456-123456');
}
$gf_lic_details = new stdClass();
$gf_lic_details->license = 'valid';
set_transient( 'gravityflow_license_details', $gf_lic_details, YEAR_IN_SECONDS * 10 );
