...
class Gravity_Flow_Installation_Wizard_Step_Updates extends Gravity_Flow_Installation_Wizard_Step {
	...
	function display() {
		...
		//	$this->background_updates = 'enabled';
			$this->background_updates = 'disabled';
		...
		<p>
			...
			<?php
esc_html_e( 'This feature is disabled by default unless you opt to activate it below. We only recommend disabling automatic updates if you intend on managing updates manually. A valid license is required for automatic updates.', 'gravityflow' );
			?>
