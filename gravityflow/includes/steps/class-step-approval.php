	...
	public function workflow_detail_box( $form, $args ) {
		...
		if ( $this->confirmation_prompt ) {
			...
			*/
			...
			$messages['approveMessage'] = wp_kses_post( $confirmation_approval['approveMessage'] );
			$messages['rejectMessage']  = wp_kses_post( $confirmation_approval['rejectMessage'] );
			$messages['revertMessage']  = wp_kses_post( $confirmation_approval['revertMessage'] );
